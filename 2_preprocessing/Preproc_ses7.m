...
%Can be used as bash script using the "preproc_sessubmit.sh" and
%"Preproc_ses.submit" files
%In terminal use ./Preproc_sessubmit.sh
...
parpool;
global CCN;
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/Marjolein/typical_data_analysis/2_preprocessing')); %This is the code path
spm_path='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/spm12_elp'; %This is your spm path
tpm='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/templates_cerebroMatic/ELP_ses_7/mw_com_prior_Age_0096.nii'; %This is your template path
addpath(genpath(spm_path));
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/Marjolein/Morph_7'; %This is your project folder
...
% data_info='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/data_info.xlsx'; %final_sample sheet, the subject column should have sub plus subject number.(e.g. sub-5003)
% if isempty(subjects)
