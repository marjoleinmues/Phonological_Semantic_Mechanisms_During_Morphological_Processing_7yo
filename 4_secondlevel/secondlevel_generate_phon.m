...
% Last modified: 11/07/2024 by Marjolein
...
out_dir='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/Marjolein/Morph_5/secondlevel_phon';
...
CCN.func_pattern = 'sub*Phon*'; %name of your functional folders
analysis_folder = 'ses5_analysis_phon'; % the name of your folder to be analyzed (first-level analysis)
...
%SES-7 
name{1} = 'elision_scaled_score'; %raw score
val{1} = [12, 13, 12, 11, 11, 14, 17, 19, 11, 15, 12, 11, 15, 11, 11, 11, 15, 11, 14, 11, 9, 9, 12, 15, 15, 11, 13, 10, 11, 11, 11, 10];
