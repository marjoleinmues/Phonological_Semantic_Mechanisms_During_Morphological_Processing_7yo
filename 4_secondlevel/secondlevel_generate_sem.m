...
% Last modified: 06/21/2024 by Marjolein
...
out_dir='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/Marjolein/Morph_5/secondlevel_sem';
...
CCN.func_pattern = 'sub*Sem*'; %name of your functional folders
analysis_folder = 'ses5_analysis_sem'; % the name of your folder to be analyzed (first-level analysis)
...
%SES-7 
name{1} = 'wordclasses_scaled_score'; %raw score
val{1} = [14, 19, 12, 17, 11, 17, 14, 18, 17, 19, 18, 7, 12, 15, 11, 9, 14, 13, 19, 14, 13, 15, 15, 16, 17, 13, 19, 15, 14, 14, 13, 9];
name{2} = 'kbit_scaled_score'; %raw score
val{2} = [120, 107, 104, 112, 96, 115, 131, 115, 121, 103, 115, 89, 112, 99, 89, 96, 89, 86, 151, 106, 96, 118, 89, 96, 128, 92, 89, 80, 117, 136, 93, 112];
