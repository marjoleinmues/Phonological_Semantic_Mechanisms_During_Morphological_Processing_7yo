...
% Last modified: 06/18/2024 by Marjolein, script for the correlation of
% grammatical with language (sentence repetition)
...
out_dir='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/Marjolein/Morph_5/secondlevel_gram';
...
%SES-7 
name{1} = 'celf_sentence_rep'; %raw score
val{1} = [15, 16, 12, 13, 10, 12, 15, 14, 18, 13, 14, 12, 14, 11, 14, 14, 13, 11, 18, 13, 14, 15, 13, 10, 14, 11, 16, 12, 11, 13, 10, 9];
